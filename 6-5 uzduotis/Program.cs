...
namespace _6_5_uzduotis
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (sk1 < sk2 && sk2 < sk3)
            {
                Console.WriteLine("Skaicius {0} yra maziausias is [{0}, {1}, {2}].", sk1, sk2, sk3);
            }
            else if (sk2 < sk1 && sk1 < sk3)
            {
                Console.WriteLine("Skaicius {1} yra maziausias is [{0}, {1}, {2}].", sk1, sk2, sk3);
            }
            else //if (sk3>sk1 && sk3>sk2)
            {
                Console.WriteLine("Skaicius {2} yra maziausias is [{0}, {1}, {2}].", sk1, sk2, sk3);
            }
